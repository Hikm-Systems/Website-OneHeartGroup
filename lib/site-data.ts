...
export const technologyHighlights = [
  ...
  { title: "Cloud Integration", description: "Cloud-native architecture ensuring uptime, scalability, and data security." },
  { title: "Secure Operations", description: "Enterprise-grade security protocols protecting your data and transactions." },
